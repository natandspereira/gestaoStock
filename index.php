...
<head>
    ...
    <title>GestãoStock - Sistema para Construção Civil</title>
    <!-- LINK CSS -->
...
<body>
    ...
    <!-- MAIN -->
    <main>
        <section id="gestaoStock">
            <h1>GestãoStock – O Controle Total da Sua Obra Começa Aqui</h1>
            <p>O sistema de gestão de estoque feito sob medida para a construção civil</p>
            <p>Evite prejuízos, mantenha o controle dos seus equipamentos e tenha uma visão completa das suas finanças — tudo em um só lugar.</p>
            <button class="abrirModal" onclick="abrir()">Quero conhecer</button>
        </section>
        ...
        <section id="relacionamento">
            ...
            <div class="container">
                    <div>
                        <p>Gestão de fornecedores com dados sempre atualizados e fácil acesso</p>
                    </div>
                    <div>
                        <p>Cadastre e acompanhe clientes com histórico de serviços, pagamentos e equipamentos utilizados</p>
                    </div>
            </div>
            <button class="abrirModal">Quero conhecer</button>
        </section>
        ...
        <section id="financeira">
            ...
            <div class="container">
                ...
                <div>
                    <p>Relatórios automáticos que ajudam na tomada de decisão estratégica</p>
                </div>
            </div>
        </section>
        ...
        <section id="valores">
            <div class="container">
                <div>
                    ...
                    <span>
                        <label>
                            <i class="material-icons" id="iconCircle">check_circle</i>
    ...
    <!-- FOOTER -->
     <footer>
        <div class="logo">
            <img src="./src/assets/img/logo_footer.svg" alt="logo">
        </div>
    ...
    <div id="modal" class="modal">
        <div class="container">
            <label for="fecharModal">
                <i class="material-icons fechar" id="fecharModal" >dangerous</i>
            </label>
            <h2 class="textoModal">Entre em contato</h2>
            <p class="textoModal">Preencha o formulário para conhecer mais sobre o GestãoStock</p>
            <form action="enviar.php" method="post">
                <input type="text" name="nome" placeholder="Seu nome" required>
                <input type="email" name="email" placeholder="Seu e-mail" required>
                <input type="tel" name="telefone" id="telefone" placeholder="(DD)99999-9999">
